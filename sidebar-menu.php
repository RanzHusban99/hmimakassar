...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
  ...
  if ($_GET["module"]=="obat" || $_GET["module"]=="form_obat") { ?>
    <li class="active">
      <a href="?module=obat"><i class="fa fa-folder"></i> Data Kader </a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="obat_masuk" || $_GET["module"]=="form_obat_masuk") { ?>
    <li class="active">
      <a href="?module=obat_masuk"><i class="fa fa-clone"></i> Data Kader Masuk </a>
      </li>
  <?php
  }
  ...
  <?php
	...
	if ($_GET["module"]=="lap_stok") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li class="active"><a href="?module=lap_stok"><i class="fa fa-circle-o"></i> Stok Kader </a></li>
        		<li><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Kader Masuk </a></li>
      		</ul>
    	</li>
    <?php
	}
	...
	elseif ($_GET["module"]=="lap_obat_masuk") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li><a href="?module=lap_stok"><i class="fa fa-circle-o"></i> Stok Kader </a></li>
        		<li class="active"><a href="?module=lap_obat_masuk"><i class="fa fa-circle-o"></i> Kader Masuk </a></li>
      		</ul>
    	</li>
    <?php
	}
