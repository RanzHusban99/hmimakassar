...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Aplikasi Pengkaderan HMI</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Database Kader HMI">
    <meta name="author" content="Husban" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:30px">HMI</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 - <a href="hmimakassar.tech">HMI Makassar</a></strong>
      </footer>
    </div><!-- ./wrapper -->
