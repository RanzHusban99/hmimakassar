...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Login | Aplikasi Pengkaderan HMI</title>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/HMI.png" />
    ...
    <!-- Custom CSS -->
    <link href="assets/css/styleU.css" rel="stylesheet" type="text/css" />

  </head>
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#055412" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/HMI.png" alt="Logo" height="50"> <b>HMI</b>
      </div><!-- /.login-logo -->
      <?php  
